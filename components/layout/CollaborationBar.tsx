...
import MeAvatarWithCounter from '../ui/MeAvatarWithCounter';

export default function CollaborationBar() {
  // Example avatar data - you can modify these
  const avatars = [
    { id: 1, text: 'JR', bgColor: 'var(--colors-lilac300)', textColor: 'var(--colors-lilac900)' },
    { id: 2, text: 'OT', bgColor: 'var(--colors-cyan550)', textColor: 'var(--colors-cyan50)' },
    { id: 3, text: 'AL', bgColor: 'var(--colors-orange300)', textColor: 'var(--colors-orange900)' }
  ];

  const meAvatarData = {
    text: 'ME',
    bgColor: 'var(--colors-coral300)',
    textColor: 'var(--colors-coral900)',
    counterText: '+7'
  };
    ...
    <>
      <div className="collaboration-bar-container">
        <div className="collaboration-bar">
          ...
          <div className="avatars-section">
            ...
            {/* Special ME avatar with counter */}
            <MeAvatarWithCounter
              text={meAvatarData.text}
              bgColor={meAvatarData.bgColor}
              textColor={meAvatarData.textColor}
              counterText={meAvatarData.counterText}
              size="medium"
            />
          </div>
          ...
          <div className="actions-section">
            ...
            <Button variant="secondary" size="medium">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4.88881 2.66663L12.6666 7.23805V8.76186L4.88881 13.3333L3.33325 12.5714V3.42853L4.88881 2.66663Z" fill="currentColor" />
              </svg>
              Present
            </Button>
      ...
      <style>{`
        ...
        .collaboration-bar {
          ...
          border-radius: 8px;
          box-shadow: 0 2px 8px var(--colors-alpha-black100);
          padding: 0 8px;
          gap: 8px;
          white-space: nowrap;
