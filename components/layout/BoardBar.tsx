    ...
    <>
            ...
            <div className="logo-container">
              <svg width="65" height="24" viewBox="0 0 65 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_994_9618)">
                  <path d="M36.4104 13.9198V22.8876H40.084V14.4696C40.084 10.7204 45.1876 10.7144 45.1876 10.7144V7.0658C45.1876 7.0658 43.7606 7.12925 42.6333 7.38303C39.4363 8.10206 36.4104 9.67911 36.4104 13.9198Z" fill="var(--icon-neutrals)" />
                  <path d="M8.71746 6.88446C10.1484 6.88446 11.9366 7.69413 12.9102 9.11811C13.9181 7.82304 15.5758 6.94891 17.6241 6.91568C20.226 6.88245 23.4431 8.5018 23.4431 13.3588V22.8765H19.7685V13.3588C19.7685 11.7395 18.5976 10.5753 16.8448 10.5753C15.092 10.5753 13.9201 11.7395 13.9201 13.3588V22.8765H10.2466V13.3588C10.2466 11.7395 9.07671 10.5753 7.3219 10.5753C5.56709 10.5753 4.36382 11.7395 4.36382 13.3588V22.8765H0.5V7.36685H4.36382V8.92476C5.40517 7.66292 6.93127 6.88446 8.71947 6.88446H8.71746Z" fill="var(--icon-neutrals)" />
                  <path d="M31.8909 7.56433V22.8877H28.1545V7.56433H31.8909Z" fill="var(--icon-neutrals)" />
                  <path d="M30.0225 5.12624C31.1744 5.12624 32.1083 4.197 32.1083 3.0507C32.1083 1.90441 31.1744 0.975159 30.0225 0.975159C28.8706 0.975159 27.9368 1.90441 27.9368 3.0507C27.9368 4.197 28.8706 5.12624 30.0225 5.12624Z" fill="var(--icon-neutrals)" />
                  <path d="M55.164 6.85126C50.6403 6.85126 46.9739 10.4998 46.9739 15.0014C46.9739 19.5029 50.6403 23.1515 55.164 23.1515C59.6876 23.1515 63.354 19.5029 63.354 15.0014C63.354 10.4998 59.6876 6.85126 55.164 6.85126ZM55.164 19.4868C52.6035 19.4868 50.5269 17.4213 50.5269 14.8724C50.5269 12.3236 52.6026 10.2581 55.164 10.2581C57.7253 10.2581 59.801 12.3236 59.801 14.8724C59.801 17.4213 57.7253 19.4868 55.164 19.4868Z" fill="var(--icon-neutrals)" />
                </g>
                <defs>
      ...
      <style>{`
        ...
        .board-bar {
          ...
          align-items: center;
          height: 48px;
          background: var(--background-neutrals);
          border-radius: 8px;
          box-shadow: 0 2px 8px var(--colors-alpha-black200);
          padding: 0 16px;
          width: auto;
          gap: 20px;
        }
        ...
        .ai-beta-badge {
          background: var(--colors-lilac200);
        ...
        .internal-badge {
          background: var(--colors-sunshine200);
